...
function writeNav(imageToggle) {
    ...
    function firstButton() {
        ...
        if (pg > 1) {
            ...
            return `<a title="Go to first comic" class='sidebutton' href="?pg=` + 1 + navScrollTo + `"/>` + imgOrText(imageToggle, 0) + `</a>`;
        } else {
            if (!imageToggle) {
                return `<span class='sidebutton'>` + imgOrText(imageToggle, 0)+ `</span>`;
            } else {
                return ``;
            }
        }
    ...
    function prevButton() {
        ...
        if (pg > 1) {
            //wait until page 2 to make button active
            return `<a title="Previous comic" href="?pg=` + (pg - 1) + navScrollTo + `"/>` + imgOrText(imageToggle, 1) + `</a>`;
        } else {
            if (!imageToggle) {
                return `<span>` + imgOrText(imageToggle, 1) + `</span>`;
            } else {
                return ``;
            }
        }
    ...
    function nextButton() {
        ...
        if (pg < maxpg) {
            ...
            return `<a title="Next comic" href="?pg=` + (pg + 1) + navScrollTo + `"/>` + imgOrText(imageToggle, 2) + `</a>`;
        } else {
            if (!imageToggle) {
                return  `<span>` + imgOrText(imageToggle, 2) + `</span>`;
            } else {
                return ``;
            }
        }
    ...
    function lastButton() {
        ...
        if (pg < maxpg) {
            ...
            return `<a title="Go to last comic" class='sidebutton' href="?pg=` + maxpg + navScrollTo + `"/>` + imgOrText(imageToggle, 3) + `</a>`;
        } else {
            if (!imageToggle) {
                return `<span class='sidebutton'>` + imgOrText(imageToggle, 3) + `</span>`;
            } else {
                return ``;
            }
        }
